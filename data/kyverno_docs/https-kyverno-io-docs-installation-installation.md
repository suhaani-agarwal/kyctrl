---
source_url: https://kyverno.io/docs/installation/installation/
...
![Kyverno Installation](/_astro/kyverno-installation.BFO-kFnO_FPvAh.webp)
...
[Section titled “Kubernetes Compatibility”](#kubernetes-compatibility)
...
[Section titled “Non-Production Installation”](#non-production-installation)
...
[Section titled “High Availability Installation”](#high-availability-installation)
...
[Section titled “Reports Server (Optional)”](#reports-server-optional)
...
[Section titled “Platform Specific Settings”](#platform-specific-settings)
...
[Section titled “Pre-Release (RC) Installations”](#pre-release-rc-installations)
...
[Section titled “Pod Security Policies (Optional)”](#pod-security-policies-optional)
...
[Section titled “Install Kyverno using YAMLs”](#install-kyverno-using-yamls)
...
[Section titled “Install main (latest)”](#install-main-latest)
...
[Section titled “Security vs Operability”](#security-vs-operability)
...
[Edit page](https://github.com/kyverno/website/edit/main/src/content/docs/docs/installation/installation.mdx)

[Previous   
 Releases](/docs/installation/releases/)   [Next   
