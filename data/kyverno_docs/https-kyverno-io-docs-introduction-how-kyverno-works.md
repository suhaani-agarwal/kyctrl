---
source_url: https://kyverno.io/docs/introduction/how-kyverno-works/
kyverno_version: unversioned
title: How Kyverno Works | Kyverno
---
...
[Section titled “Kubernetes Controllers”](#kubernetes-controllers)
...
![Kyverno Architecture](/_astro/kyverno-architecture.FuOJroL0_2jT2Ec.webp)
...
For more details see the [Kyverno Authz](https://kyverno.github.io/kyverno-authz/latest/) documentation.

## Kyverno SDK

[Section titled “Kyverno SDK”](#kyverno-sdk)

The Kyverno SDK allows building and running Kyverno engines in your own application or service.

[Edit page](https://github.com/kyverno/website/edit/main/src/content/docs/docs/introduction/how-kyverno-works.md)

[Previous   
 Introduction](/docs/introduction/)   [Next   
 Kyverno Quick Start](/docs/introduction/quick-start/)