---
source_url: https://kyverno.io/docs/installation/releases/
kyverno_version: unversioned
title: Releases | Kyverno
---
...
[Section titled “Release Management”](#release-management)

This section provides guidelines on release timelines and release branch maintenance.

### Release Timelines

[Section titled “Release Timelines”](#release-timelines)
...
[Section titled “Branches and PRs”](#branches-and-prs)
...
[Section titled “Release Planning”](#release-planning)
...
[Section titled “Release Instructions”](#release-instructions)

For release instructions, see [release.md](https://github.com/kyverno/kyverno/blob/main/docs/dev/releases/create-a-release.md).

[Edit page](https://github.com/kyverno/website/edit/main/src/content/docs/docs/installation/releases.md)

[Previous   
 Kyverno Quick Start](/docs/introduction/quick-start/)   [Next   
